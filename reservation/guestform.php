...
if(isset($_SESSION['username'])){
$homepage = "<a href=\"sessiondestroy.php?unset=2\" class=\"button round blackblur fontslabo\" >1</a>";
}
else{$homepage = "<a href=\"sessiondestroy.php?unset=21\" class=\"button round blackblur fontslabo\" >1</a>";}
	include './auth.php';
					...
					if(mysqli_num_rows($result) > 0){
						...
						while($row = mysqli_fetch_array($result)){
							...
							if (isset($_POST["qtyroom".$row['room_id'].""])   && !empty($_POST["qtyroom".$row['room_id'].""]) )
							{
								...
								$_SESSION['deposit'] = $_SESSION['total_amount'] * 0;
								$count = $count + 1;
							}
						}
...
<title>Reservation-Guest Detail</title>
...
<body class="fontbody">
<div class="row foo" style="margin:30px auto;">
<div class="large-12 columns">
	...
	<?php echo"<a href=\"sessiondestroy.php?unset=4\" class=\"button round blackblur fontslabo\" >2</a>"; ?>
...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<div class="large-12 columns " >
		<p><b>Your Reservation Detail</b></p><hr class="line">
				...
				<div class="row">					
					<div class="large-12 columns" style="max-width:100%;">
						...
						<!--span class="fontslabo2 " style="font-size:32px; text-align:center;">GHS <?php// echo $_SESSION['deposit'];?></span-->
						<br><span class="fontgrey" style="text-align:center;">Total Amount</span><br>
						<span class="fontslabo2" style="font-size:32px; text-align:center;">GHS <?php echo $_SESSION['total_amount'];?></span>
					</p>
				  ...
				  <!--div class="row">
					<div class="large-12 columns" >
						<button name="submit" href="#" class="button small fontslabo2" style="background-color:#2ecc71; width:100%;">Edit Reservation</button>
					</div>
				  </div-->
				</form>
		</div>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		<p><h4>Guest Details</h4><hr class="line"></p>
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  ...
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Address Line*
			...
			<div class="large-6 columns">
			  <label class="fontcolor">Country*
				<select name="country" id="country" type="text" placeholder=""   required>
						...
						{
						echo "<option value=\"Ghana\" selected=\"true\">Ghana</option>";
						}
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo21" style="background-color:#2ecc71;" onclick="return confirm('Are you sure you want to continue?')" >Proceed</button>
		  </div>
